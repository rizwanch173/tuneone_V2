...
class GenreMediaListRadioView extends StatelessWidget {
  ...
  GenreMediaListRadioView({required this.title, required this.genreId});
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: ListView.builder(
                            ...
                            itemBuilder: (_, index) {
                              if (dataController
                                  .radioListMasterCopy[index].genres
                                  .contains(genreId)) {
                                return Padding(
