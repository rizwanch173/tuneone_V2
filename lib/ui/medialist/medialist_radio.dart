                                      ...
                                      ? Padding(
                                          ...
                                          child: ListView.builder(
                                              itemCount: dataController
                                                  .radioListMasterCopy.length,
                                              itemBuilder: (_, index) {
                                                if (dataController
                                                        .userList.userMeta.likes
                                                                  ...
                                                                  return IconButton(
                                                                      onPressed:
                                                                        ...
                                                                        dataController.addRecently(
                                                                            dataController.radioListMasterCopy[index],
                                                                            false);
                                                                        radio.indexX =
                                                                            index;
                                                                        if (homeController.whoAccess.value ==
                                                                          ...
                                                                          if (playing) {
                                                                            ...
                                                                            if (AudioService.currentMediaItem!.id ==
                                                                                dataController.mediaListRadio[index].id) {
                                                                              AudioService.pause();
                                                                            } else {
                                                                              await AudioService.skipToQueueItem(dataController.mediaListRadio[index].id);
                                                                              AudioService.play();
                                                                            }
                                                                          } else {
                                                                            print("not running");
                                                                            print(dataController.mediaListRadio.length);
                                                                            if (!running) {
                                                                              AudioService.start(
                                                                                ...
                                                                                await AudioService.updateQueue(dataController.mediaListRadio);
                                                                                AudioService.skipToQueueItem(dataController.mediaListRadio[index].id);
                                                                                print("start call");
                                                                      ...
                                                                      icon: (radio.indexX == index &&
                                                                              !playing)
                                                                          ? CupertinoActivityIndicator()
                                                                          : playing
                                                                              ? AudioService.currentMediaItem!.id != dataController.mediaListRadio[index].id
                                                                                  ? Icon(
                                                                                      Icons.play_arrow,
                                                                                      color: Colors.white,
                                                                                    )
